...
import { fetchTasks } from "@/app/lib/features/tasks/taskAction";
...
export default function Dashboard() {
	...
	useEffect(() => {
		if (role && username) {
			dispatch(fetchTasks(role, username));
		}
	...
	const totalPages = useMemo(
		() => Math.ceil(filteredTasks.length / Number(rowPerPage)),
		[filteredTasks, rowPerPage]
	);
